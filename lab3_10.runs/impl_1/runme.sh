...
HD_PWD='C:/fs/lab3_10/lab3_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arbiter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arbiter.tcl -notrace
